...
public class Car {
		...
		public void setColor(int color) {
			...
			System.out.println("매개변수 없이 인스턴스를 만들었을떄");
			System.out.println("이 생성자가 처리할 고유의 코드들");
		}
		
		// 생성자-> 인스턴스가 만들어질 떄마다 자동으로 호출되는메서드
		// 일반적인 매서드가 아니므로 이름이 정해져있음
		// 생성자 매서드의 이름은 클래스의 이름과 같아야한다
		// 생성자 매서드는 반환타입이 없다
		// 생성자의 접근 제어자는 public, private 중 하나를 쑬 수있다.
		public Car() {
			// 인스턴스를 만들 떄
